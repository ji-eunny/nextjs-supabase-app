          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {displayGroups.length}개의 모임에 가입되어 있습니다
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          {displayGroups.length > 0 ? (
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">
                          최대 {group.max_members}명
                        </span>
                      </div>
                      {/* 더미 데이터의 next_event_title 표시 */}
                      {dummyGroups.find(g => g.id === group.id)?.next_event_title && (
                        <div className="flex items-start gap-2">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-muted-foreground">
                              {new Date(dummyGroups.find(g => g.id === group.id)?.next_event_at || "").toLocaleDateString('ko-KR', {
                                month: 'short',
                                day: 'numeric',
                              })}
                            </p>
            ...
            <div className="flex flex-col items-center justify-center py-20 px-4">
              ...
              <Button asChild>
                <Link href="/protected/groups/new">새 모임 만들기</Link>
              </Button>
            </div>
          )}
        </div>
